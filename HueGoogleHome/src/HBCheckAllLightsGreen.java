...
public class HBCheckAllLightsGreen
{
  ...
  public String HBCheckAllLightsToGreen(PHBridge bridge, String utcdate)
 ...
 /*     	TimeZone timeZone = TimeZone.getTimeZone("UTC");
   		...
   		if(Status=="PASS")
   	    {
   			String sql = "INSERT INTO IV_US.RESULTS"+"(runDateTime,testCaseId,isPassed,actualResult,failureReason,APIVersion,SWVersion)"+
   					"Values('"+utcdate+"','4','1','All Lights Turned GREEN','"+Remarks+"','"+BridgeAPIVersion+"' ,'"+SoftwareVersion+"')";
   			myStmt.executeUpdate(sql);
   	
   	    }else {
   			String sql = "INSERT INTO IV_US.RESULTS"+"(runDateTime,testCaseId,isPassed,actualResult,failureReason,APIVersion,SWVersion)"+
   					"Values('"+utcdate+"','4','0','All Lights Didnt Turned GREEN','"+Remarks+"','"+BridgeAPIVersion+"' ,'"+SoftwareVersion+"')";
   			myStmt.executeUpdate(sql);
